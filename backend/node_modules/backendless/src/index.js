...
const SERVICES = {
  'Logging'     : () => require('./logging/index').default,
  'Counters'    : () => require('./counters/index').default,
  'Cache'       : () => require('./cache/index').default,
  'Commerce'    : () => require('./commerce/index').default,
  'Users'       : () => require('./users/index').default,
  'BL'          : () => require('./bl/index').default,
  'Geo'         : () => require('./geo/index').default,
  'Data'        : () => require('./data/index').default,
  'Messaging'   : () => require('./messaging/index').default,
  'Files'       : () => require('./files/index').default,
  'RT'          : () => require('./rt').default,
  'SharedObject': () => require('./rso/index').default,
  'LocalCache'  : () => require('./local-cache/index').default,
}
...
class Backendless {
  ...
  setupDevice(...args) {
    const { default: Device } = require('./device/index')
